...
public class EmployeeMapper {
    ...
    public com.example.prog4.repository.database1.entity.Employee toDomain(Employee employee) {
        try {
            ...
            com.example.prog4.repository.database1.entity.Employee domainEmployee = com.example.prog4.repository.database1.entity.Employee.builder()
                    .id(employee.getId())
    ...
    public Employee toView(com.example.prog4.repository.database1.entity.Employee employee) {
